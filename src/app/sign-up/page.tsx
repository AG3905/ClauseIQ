    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col transition-colors duration-200">
      ...
      <header className="p-4 px-6 flex items-center justify-between border-b border-border bg-background/95">
        <Link href="/" className="flex items-center gap-2.5">
          <div className="w-9 h-9 rounded bg-[#8C6721] dark:bg-[#C99A52] flex items-center justify-center text-white dark:text-[#171512]">
      ...
      <div className="flex-1 flex">
        ...
        <div className="hidden lg:flex flex-1 items-center justify-center p-12 bg-muted/40 border-r border-border">
          <div className="max-w-md space-y-8">
            <div className="paper-card rounded-lg p-8 space-y-4">
              <div className="w-10 h-10 rounded bg-[#F9F5EB] dark:bg-[#2A2621] border border-[#E6CFAB] dark:border-[#343029] flex items-center justify-center text-[#8C6721] dark:text-[#C99A52]">
        ...
        <div className="flex-1 flex items-center justify-center p-6 bg-background">
          <div className="w-full max-w-md">
            <div className="paper-card rounded-lg p-8 space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <Input id="firstName" placeholder="Counsel" className="pl-10 h-10 bg-card border-border focus:border-[#8C6721] text-xs font-sans text-foreground" />
                    </div>
                  </div>
                  <div className="space-y-1.5">
                    <Label htmlFor="lastName" className="text-xs font-mono text-foreground">Last Name</Label>
                    <Input id="lastName" placeholder="Senior" className="h-10 bg-card border-border focus:border-[#8C6721] text-xs font-sans text-foreground" />
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input id="org" placeholder="Legal Partners LLP" className="pl-10 h-10 bg-card border-border focus:border-[#8C6721] text-xs font-sans text-foreground" />
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input id="email" type="email" placeholder="counsel@firm.com" className="pl-10 h-10 bg-card border-border focus:border-[#8C6721] text-xs font-sans text-foreground" />
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input id="password" type="password" placeholder="••••••••" className="pl-10 h-10 bg-card border-border focus:border-[#8C6721] text-xs font-mono text-foreground" />
                  </div>
                </div>

                <Button
                  type="submit"
                  className="w-full h-10 bg-[#8C6721] hover:bg-[#6E4E1C] dark:bg-[#C99A52] dark:hover:bg-[#B38743] text-white dark:text-[#171512] text-xs font-semibold border border-[#785628] dark:border-[#B38743] shadow-xs"
                  disabled={loading}
                >
                  {loading ? (
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button variant="outline" className="h-10 bg-card border-border hover:bg-muted text-xs text-foreground font-semibold">
                  Google
                </Button>
                <Button variant="outline" className="h-10 bg-card border-border hover:bg-muted text-xs text-foreground font-semibold">
                  Single Sign-On
